...
export default function SurahReadingControls() {
  ...
  return (
    ...
    <div className="sticky top-16.75 sm:top-16.25 z-30 mb-6 w-full">
      <motion.div
        layout
        className="backdrop-blur-xl glass rounded-2xl overflow-hidden shadow-lg"
      >
        {/* Toggle Button */}
        <button
          onClick={toggleIsExpandedReadingControls}
          className="w-full flex items-center justify-between px-5 py-2.5 text-text-secondary hover:text-text-primary transition-all duration-500 cursor-pointer group"
        >
          <div className="flex items-center gap-2">
            ...
            />
            <span className="text-[11px] sm:text-xs font-jakarta font-medium uppercase tracking-wider">
              Reading Controls
            </span>
          </div>
          <motion.div
            animate={{ rotate: isExpandedReadingControls ? 180 : 0 }}
        ...
        <AnimatePresence initial={false}>
          {isExpandedReadingControls && (
            ...
            >
              <div className="flex flex-wrap items-center justify-evenly px-5 pb-4 pt-2 gap-x-6 gap-y-3 border-t border-text-secondary/5">
                {/* Font Size */}
                <div className="flex flex-1 sm:flex-none items-center justify-evenly gap-2">
                ...
                <div className="flex flex-1 sm:flex-none items-center justify-evenly gap-4">
                  ...
                  <AnimatePresence mode="popLayout">
                    {!mushafMode ? (
                      ...
                      <motion.button
                        ...
                        aria-label={
                          audioPlaying ? "Pause recitation" : "Play recitation"
                        }
