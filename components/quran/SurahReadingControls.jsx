...
export default function SurahReadingControls() {
  ...
  return (
    // ── Controls Bar ──
    <div className="sticky top-16.75 sm:top-16.25 z-30 backdrop-blur-xl flex flex-wrap items-center justify-evenly glass rounded-2xl px-5 py-3 gap-x-6 gap-y-3 mb-6">
      {/* Font Size */}
