    ...
    >
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-center justify-between gap-2">
          ...
          <span
            aria-hidden
            className="pointer-events-none select-none absolute right-16 -top-4 font-quran text-[2.5rem] sm:text-[3rem] leading-none text-accent opacity-50 group-hover:opacity-100 group-hover:-translate-x-1 transition-all duration-500 whitespace-nowrap"
          >
            {surah.name_arabic}
          </span>
        </div>
