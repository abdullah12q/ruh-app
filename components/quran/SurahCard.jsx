...
export default function SurahCard({ surah }) {
  ...
  return (
    <Link
      href={`/quran/${surah.id}`}
      className="group relative overflow-hidden glass rounded-2xl p-5 flex items-center gap-4 hover:border-(--accent)/30 transition-all duration-200 hover:shadow-[0_0_20px_rgba(20,184,166,0.08)]"
    >
      {/* Surah Number Badge */}
