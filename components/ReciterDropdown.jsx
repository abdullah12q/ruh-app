  ...
  return (
    <div className="relative text-start" ref={dropdownRef}>
      <button
        ...
        className="flex items-center gap-2 glass rounded-xl px-3 py-2 text-xs text-text-secondary hover:text-text-primary transition-all w-auto max-w-xs cursor-pointer"
      >
      ...
      <AnimatePresence>
        {dropdownOpen && (
          <motion.div
            ...
            className={`absolute top-full mt-2 ${isPositionCentered ? "left-1/2 translate-x-[-50%] sm:left-0 sm:translate-x-0" : "right-0"} z-50 w-72 rounded-2xl overflow-hidden shadow-2xl bg-background border border-text-secondary/10`}
